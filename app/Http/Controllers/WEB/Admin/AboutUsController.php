...
class AboutUsController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $aboutUs->top_header_text = $request->top_header_text;
        ...
        $aboutUs->home_seo_title = $request->home_seo_title;
        $aboutUs->home_seo_description = $request->home_seo_description;
        $aboutUs->home_keywords = $request->home_keywords;
        $aboutUs->save();
