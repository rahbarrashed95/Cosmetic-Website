       ...
       if(!auth()->user()->can('productCategory.store')){
        ...
        $category = new Category();
      	...
      	if($request->image){
            ...
            $destation_path = 'uploads/category/big-images/'.$image_name;            
            $image->resize(500,500);
            $image->save(public_path().'/'.$destation_path);   
          	$category->image = $image_name;
          	
          	
          	$destation_path1 = 'uploads/category/small-images/'.$image_name; 
            $image->resize(48,48);
        ...
        $category->icon = $request->icon;
      	...
      	$category->cat_seo_title = $request->cat_seo_title;
      	$category->cat_seo_description = $request->cat_seo_description;
      	$category->is_single = $request->is_single;
        $category->save();
    ...
    public function update(Request $request,$id)
    {
      if(!auth()->user()->can('productCategory.update')){
        ...
        if($request->image){
            ...
            $destation_path2 = 'uploads/category/big-images/'.$image_name; 
            $image->resize(500,500);
