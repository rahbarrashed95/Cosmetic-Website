                            ...
                            <form action="{{ route('admin.about-us.update',$aboutUs->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-12">
                                        <label for="">{{__('Top Header Text')}} <span class="text-danger">*</span></label>
                                        <input type="text" required name="top_header_text" class="form-control" value="{{ $aboutUs->top_header_text }}">
                                    </div>
                                    ...
                                    <div class="form-group col-12">
                                        <label for="">Home Seo Title<span class="text-danger">*</span></label>
                                        <input required type="text" name="home_seo_title" class="form-control" value="{{ $aboutUs->home_seo_title }}">
                                    </div>
                                    
                                    <div class="form-group col-12">
                                        <label>Home Seo Description <span class="text-danger">*</span></label>
                                        <textarea required name="home_seo_description" cols="30" rows="10" class="form-control" style="height: 200px;">{{ $aboutUs->home_seo_description }}</textarea>
                                    </div>
                                    
                                    <div class="form-group col-12">
                                        <label>{{__('Keywords')}} <span class="text-danger">*</span></label>
                                       <input type="text" class="form-control tags" name="home_keywords" value="{{ $aboutUs->home_keywords }}">
                                    </div>
