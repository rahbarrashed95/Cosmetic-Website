        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item">{{__('Create Combo Product')}}</div>
            </div>
          </div>

          <div class="section-body">
            <a href="{{ route('admin.combo-product.index') }}" class="btn btn-primary"><i class="fas fa-list"></i> {{__('Combo Products')}}</a>
            <div class="row mt-4">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.combo-product.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
