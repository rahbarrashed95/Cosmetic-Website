                        ...
                        <form action="{{ route('admin.product.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-4">
                                   ...
                                   <input type="text" class="form-control" name="wholesell_price_discount" value="{{ old('wholesell_price_discount') }}">
                                </div>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <textarea name="ingredients" id="" cols="30" rows="5" class="summernote">{{ old('ingredients') }}</textarea>
                                </div>
                                
                                <div class="form-group col-12">
                                    <label>{{__('How To Use')}} <span class="text-danger">*</span></label>
                                    <textarea name="how_to_use" id="" cols="30" rows="5" class="summernote">{{ old('how_to_use') }}</textarea>
                                </div>
                            ...
                            <div class="row">
                                    <div class="col-md-5 d-none">
                                         <div id="variable_table_two" class="" style="">
                                        ...
                                        <table class="table table-centered table-nowrap table-bordered text-center color_table">
                                            ...
                                            <tbody>
                                                <tr id="color_row">
                                                    ...
                                                    <td>
                                                        <input class="variable_product_image form-control" type="file" name="var_images[]">
                                                    </td>
                                                    ...
                                                    <td>
                                                        <input class="variable_stock_quantity form-control" type="number" name="stock_quantity[]" placeholder="Quantity">
                                                    </td>
...
$(document).on('blur', 'input[id="name"]', function(e){
    ...
    $.ajax({
        ...
        success: function(res){
          ...
          {
              $("input#slug").val('');
              $('span#name_test').text('The same name has been used before. Make a slight change.');
          } else {
              $('span#name_test').text('');
          }
        }
...
// manage variation quantity end
    ...
    $(document).on('click','a.add_moore_color', function(){
            ...
            let variable_product_price = tblrow.find('td input.variable_sell_price').val();
            ...
            let row=`<tr id="color_row">
                ...
                <td>
                    <input class="variable_stock_quantity form-control" type="number" name="stock_quantity[]" placeholder="Price">
                </td>
