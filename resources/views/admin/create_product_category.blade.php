                        ...
                        <form action="{{ route('admin.product-category.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <textarea id="cat_description" class="form-control summernote"  name="cat_description" style="height: 150px;"></textarea>
                                </div>
                                
                                <div class="form-group col-12">
                                    <label>{{__('Short Description')}}</label>
                                    <textarea id="short_description" class="form-control summernote"  name="short_description" style="height: 150px;"></textarea>
                                </div>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <input type="text" id="cat_seo_title" class="form-control"  name="cat_seo_title">
                                </div>
                                <div class="form-group col-12">
                                    <label>{{__('Seo Description')}}</label>
                                    <textarea id="cat_seo_description" class="form-control"  name="cat_seo_description" style="height: 150px;"></textarea>
                                </div>
