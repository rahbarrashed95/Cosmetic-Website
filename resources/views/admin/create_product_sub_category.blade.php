                        ...
                        <form action="{{ route('admin.product-sub-category.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <textarea id="description" class="form-control"  name="description" style="height: 150px;"></textarea>
                                </div>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <textarea id="seo_description" class="form-control"  name="seo_description" style="height: 150px;"></textarea>
                                </div>
