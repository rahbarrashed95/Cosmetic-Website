                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.product.update',$product->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-3">
                                    <label>{{__('Youtube Thumbnail')}} <span class="text-danger">*</span></label>
                                    <input type="file" class="form-control-file"  name="youtube_thumb">
                                </div>
                            ...
                            <input type="hidden" name="product_id" required value="{{ $product->id }}">
                                ...
                                <div class="form-group col-6">
                                 ...
                                 <div class="form-group col-4">
                                    <label>Wholesale Price Discount (%)</label>
                                   <input type="text" class="form-control" name="wholesell_price_discount" value="{{ $product->wholesell_price_discount }}">
                                </div>
                                ...
                                <!--<div class="col-md-6">-->
                                <!--    <div class="form-group col-12">-->
                                <!--        <label>My Profit <span class="text-danger">*</span></label>-->
                                <!--        <input type="text" class="form-control" name="my_profit" value="{{ $product->my_profit }}"> -->
                                <!--    </div>-->
                                <!--</div>-->
                              ...
                              <!--</div>     -->
                                ...
                                <div class="form-group col-12">
                                    <label>{{__('Ingredients')}} <span class="text-danger">*</span></label>
                                    <textarea name="ingredients" id="" cols="30" rows="5" class="summernote">{{ $product->ingredients }}</textarea>
                                </div>
                                
                                <div class="form-group col-12">
                                    <label>{{__('How To Use')}} <span class="text-danger">*</span></label>
                                    <textarea name="how_to_use" id="" cols="30" rows="5" class="summernote">{{ $product->how_to_use }}</textarea>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-centered table-nowrap table-bordered text-center color_table">
                                            ...
                                            <tbody>
                                              @foreach($product->variations as $vc)
                                                ...
                                                <tr id="color_row">
                                                    ...
                                                    <td>
                                                      	<img src="{{asset($vc->var_image)}}" width="100px" height="100px" />
                                                    </td>
                                                    <td>
                                                        <input class="variable_sell_price form-control" type="text" value="{{ $vc->sell_price }}" name="sell_price[]" placeholder="Price">
                                                    </td>
                                                    <td>
                                                        <input class="variable_quantity form-control" type="text" name="stock_quantity[]" value="{{$vc->quantity}}">
                                                    </td>
                                        ...
                                        <tbody id="variation_quantity_body">
                                           @foreach($var_stock as $key=>$vstock)
                                            <tr class="">
                                                ...
                                                <td><input class="form-control" type="number" name="stockqty[]" value="{{$vstock->quantity}}"></td>
...
function handleOptionRemoval(optionType) {
    ...
    $(document).on('click','a.add_moore', function(){
  	...
  	$(document).on('click','a.add_moore_color', function(){
            ...
            let variable_quantity = tblrow.find('td input.variable_quantity').val();
            ...
            let row=`<tr id="color_row">
                ...
                <td>
                 ...
                 <td>
                    <input class="variable_stock_quantity form-control" type="number" value="${variable_quantity}" name="stock_quantity[]" placeholder="Quantity">
                </td>
