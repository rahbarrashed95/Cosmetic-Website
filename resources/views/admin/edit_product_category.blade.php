                        ...
                        <form action="{{ route('admin.product-category.update',$category->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <textarea id="cat_description" class="form-control summernote"  name="cat_description" style="height: 150px;">{{ $category->cat_description }}</textarea>
                                </div>
                                
                                <div class="form-group col-12">
                                    <label>{{__('Short Description')}}</label>
                                    <textarea id="short_description" class="form-control summernote"  name="short_description" style="height: 150px;">{{ $category->short_description }}</textarea>
                                </div>
                                
                                <div class="form-group col-12">
                                    <label>{{__('Keywords')}} <span class="text-danger">*</span></label>
                                   <input type="text" class="form-control tags" name="tags" value="{{ $category->tags }}">
                                </div>
                                
                                 <div class="form-group col-12">
                                    <label>{{__('Seo Title')}}</label>
                                    <input type="text" id="cat_seo_title" class="form-control"  name="cat_seo_title" value="{{ $category->cat_seo_title }}">
                                </div>
                                <div class="form-group col-12">
                                    <label>{{__('Seo Description')}}</label>
                                    <textarea id="cat_seo_description" class="form-control"  name="cat_seo_description" style="height: 150px;">{{ $category->cat_seo_description }}</textarea>
                                </div>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <select name="is_single" class="form-control">
                                        <option value="1" {{ $category->is_single == '1' ? 'selected' : '' }}>Single</option>
                                        <option value="0" {{ $category->is_single == '0' ? 'selected' : '' }}>Multiple</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row">
