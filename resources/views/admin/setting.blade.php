                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12">
                                    <label>Today Currency Rate<span class="text-danger">*</span></label>
                                    <input type="text" name="today_currency_rate" class="form-control" value="{{ $footer->today_currency_rate }}">
                                </div>
                                
                                <div class="form-group col-12">
                                    <label>HK Today Weight Rate<span class="text-danger">*</span></label>
                                    <input type="text" name="today_weight_rate" class="form-control" value="{{ $footer->today_weight_rate }}">
                                </div>

                                <div class="form-group col-12">
                                    <label>GZ Today Weight Rate<span class="text-danger">*</span></label>
                                    <input type="text" name="gz_weight_rate" class="form-control" value="{{ $footer->gz_weight_rate }}">
                                </div>
                                ...
                                <div class="form-group col-12">
                                    <label>{{__('Address 2')}} <span class="text-danger">*</span></label>
                                    <input type="text" name="address2" class="form-control" value="{{ $footer->address2 }}">
                                </div>
