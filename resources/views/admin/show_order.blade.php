          ...
          <div class="section-body">
            <div class="invoice">
              <div class="invoice-print">
                ...
                <div class="row">
                    <div class="col-md-12 img_section" style="text-align: center;">
                    ...
                    <div class="col-md-12 address" style="text-align: center;">
                        ...
                        <p class="web">Address: {{ footerInfo()->address }}</p>
                    </div>
                </div>
                    ...
                    <div class="table-responsive ">
                      <table class="table table-striped table-hover table-md table-bordered" style="border-bottom: 1px solid #F9EDF7;">
                        ...
                        @foreach ($order->orderProducts as $index => $orderProduct)
                            ...
                            <tr>
                                <td>{{ ++$index }}</td>
                                <td><a href="">{{ $orderProduct->product_name }}</a> @if($weight <= 0)@endif</td>
                                @if ($setting->enable_multivendor == 1)
                                <td>
