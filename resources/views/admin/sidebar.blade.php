    ...
    <aside id="sidebar-wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        @if(auth()->user()->can('admin.product') || auth()->user()->can('admin.product-brand.index') || auth()->user()->can('admin.product-variant') || auth()->user()->can('admin.create-product-variant') || auth()->user()->can('admin.edit-product-variant') || auth()->user()->can('admin.product-gallery') || auth()->user()->can('admin.product-variant-item	') || auth()->user()->can('admin.create-product-variant-item') || auth()->user()->can('admin.edit-product-variant-item') || auth()->user()->can('admin.product-review') || auth()->user()->can('admin.show-product-review'))
          ...
          <li class="{{ Route::is('admin.combo-product.index') || Route::is('admin.combo-product.index') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.combo-product.index') }}">
            <div class="icon">
                <i class="fas fa-money-check-alt"></i>
            </div>
            <span style="color:black">{{__('Combo Products')}}</span></a></li>
          @endif
          
          @if(auth()->user()->can('admin.inventory'))
          <li class="{{ Route::is('admin.certification.index') || Route::is('admin.certification.index') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.certification.index') }}">
            <div class="icon">
                <i class="fas fa-money-check-alt"></i>
            </div>
            <span style="color:black">{{__('Certification')}}</span></a></li>
          @endif
          
          @if(auth()->user()->can('admin.inventory'))
          <li class="{{ Route::is('admin.video-gallery.index') || Route::is('admin.video-gallery.index') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.video-gallery.index') }}">
            <div class="icon">
                <i class="fas fa-money-check-alt"></i>
            </div>
            <span style="color:black">{{__('Video Gallery')}}</span></a></li>
          @endif
          ...
          @if(auth()->user()->can('admin.inventory'))
            <!--<li class="{{ Route::is('admin.pc-builder') ? 'active' : '' }}">-->
            <!--    <a class="nav-link" href="{{ route('admin.pc-builder') }}">-->
            <!--        <div class="icon">-->
            <!--            <i class="fas fa-money-check-alt"></i>-->
            <!--        </div>-->
            <!--        <span style="color:black">Quotation</span>-->
            <!--    </a>-->
            <!--</li>-->
            
            
          <!--  <li class="nav-item dropdown {{ Route::is('admin.about-us.*') ? 'active' : '' }}">-->
          ...
          <!--      </div>-->
          <!--      <span>{{__('Quotation')}}</span></a>-->
          <!--      <ul class="dropdown-menu">-->
          <!--          <li class="{{ Route::is('admin.custom-page.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.pc-builder') }}">Quotation</a></li>-->
          <!--          <li class="{{ Route::is('admin.custom-page.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.wholesale-price-list') }}">Price List</a></li>-->
                    <!--<li class="{{ Route::is('admin.custom-page.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.printer.index') }}">{{__('Printer')}}</a></li>-->
          <!--      </ul>-->
          ...
          @if(auth()->user()->can('admin.inventory'))
            <li class="nav-item dropdown {{ Route::is('admin.about-us.*') ? 'active' : '' }}" style="display: none;">
            ...
            <span>{{__('Printer')}}</span></a>
            <ul class="dropdown-menu">
                <li class="{{ Route::is('admin.custom-page.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.printer-type.index') }}">{{__('Printer Type')}}</a></li>
                <li class="{{ Route::is('admin.custom-page.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.printer-series.index') }}">{{__('Printer Series')}}</a></li>
                <li class="{{ Route::is('admin.custom-page.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.printer.index') }}">{{__('Printer')}}</a></li>
            </ul>
          ...
          <p class="s-divide">{{__('admin.Shop Setup')}}</p>
            ...
            <ul class="dropdown-menu">
                ...
                <li class="{{ Route::is('admin.offers.index') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.offers.index') }}">Offers</a></li>
                <li class="{{ Route::is('admin.offer-products.index') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.offer-products.index') }}">Offer Products</a></li>
         ...
         -->
          ...
          <li class="nav-item dropdown {{ Route::is('admin.about-us.*') || Route::is('admin.custom-page.*') || Route::is('admin.terms-and-condition.*') || Route::is('admin.privacy-policy.*')  || Route::is('admin.error-page.*') || Route::is('admin.contact-us.*') || Route::is('admin.login-page') ? 'active' : '' }}">
            ...
            <ul class="dropdown-menu">
                ...
                <!--<li class="{{ Route::is('admin.about-pastel.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.about-pastel') }}">{{__('About Pastel Beauty')}}</a></li>-->
                
                <!--<li class="{{ Route::is('admin.support.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.support') }}">{{__('Support')}}</a></li>-->
