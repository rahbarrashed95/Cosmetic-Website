...
use App\Http\Controllers\WEB\Admin\PrinterTypeController;
use App\Http\Controllers\WEB\Admin\PrinterSeriesController;
use App\Http\Controllers\WEB\Admin\PrinterController;
use App\Http\Controllers\WEB\Admin\OfferController;
use App\Http\Controllers\WEB\Admin\OfferProductController;
...
use App\Http\Controllers\WEB\Admin\ComboProductController;
use App\Http\Controllers\WEB\Admin\CertificationController;
use App\Http\Controllers\WEB\Admin\VideoGalleryController;
...
Route::group(['prefix' => 'admin','middleware' => 'auth','as'=>'admin.'], function() {
    ...
    Route::resource('printer-type', PrinterTypeController::class);
    Route::resource('printer-series', PrinterSeriesController::class);
    Route::resource('printer', PrinterController::class);
    Route::get('get-series/{type_id}', [PrinterSeriesController::class,'get_series'])->name('get_series');
    
    Route::resource('offers', OfferController::class);
    Route::resource('offer-products', OfferProductController::class);
    Route::get('select-offer/{product_id}', [OfferProductController::class,'select_offer'])->name('select_offer');
...
// Route::post('/update-items', array('as'=> 'update.items', 'uses' => 'ItemController@updateItems'));
    ...
    Route::put('product-popular-change/{id}', [ProductController::class,'change_popular'])->name('product.popular.change');  
    ...
    Route::get('/whole-price-list', [ProductController::class, 'wholesale_price_list'])->name('wholesale-price-list');
    Route::get('/retrive-whole-price-list/{category_id}', [ProductController::class, 'retrive_wholesale_price'])->name('retrive_wholesale_price');
    ...
    Route::get('about-pastel', [CustomPageController::class,'about_pastel'])->name('about-pastel');
    Route::get('privacy-policy', [CustomPageController::class,'privacy_policy'])->name('privacy-policy');
    Route::get('support', [CustomPageController::class,'support'])->name('support');
    ...
    Route::put('blog-ispopular/{id}', [BlogController::class,'changeIsPopular'])->name('blog.ispopular');
    ...
    Route::get('edit-pc_builders/{id}', [HomePageController::class, 'edit_pcbuilders'])->name('edit_pcbuilders');
    ...
    Route::post('update-pc-build', [HomePageController::class, 'updatePcBuild'])->name('update-build-pc');
    ...
    Route::get('order-show/{id}', [OrderController::class, 'show'])->name('order-show');
  	...
  	Route::get('/add-New-Combo-Product-Entry-add', [OrderController::class, 'addNewComboProductEntryadd'])->name('addNewComboProductEntryadd');
...
Route::group(['as' => 'front.'], function(){
    Route::controller(FrontHomeController::class)->group(function(){
        ...
        Route::get('/pccategory/{type}/{slug}', 'pcsubCategoriesByCategory')->name('pcsubcategory');
        Route::get('/shop/{slug?}', 'shop')->name('shop');
        Route::get('/pcshop/{slug?}', 'pcshop')->name('pcshop');
        ...
        Route::get('/show/modal/cart', 'showProModalCart')->name('showProModalCart');
        Route::get('/show/blogs', 'showBlogs')->name('showBlogs');
        Route::get('/details/blogs/{id}', 'blogDetails')->name('blogDetails');
        Route::post('/comment/blogs', 'blogComment')->name('blogComment');
        Route::get('/driver-list', 'driverList')->name('driverList');
        Route::get('/get-series-data/{type_id}', 'getSeries')->name('getSeries');
        Route::get('/get-printer-data', 'getPrinter')->name('getPrinter');
        Route::get('/get-popular-products', 'get_popular_products')->name('get_popular_products');
        Route::get('/get-combo-products', 'get_combo_products')->name('get_combo_products');
        Route::get('/get-products-video', 'get_product_video')->name('get_product_video');
        Route::get('/offer-products', 'offer_products')->name('offer_products');
        Route::get('/product-video/{id}', 'product_video')->name('product_video');
        Route::get('/show-gal/{id}', 'show_gal')->name('show_gal');
        Route::get('/get-offer-product/{offerid}', 'get_offer_product')->name('get_offer_product');
    });
    ...
    Route::controller(FrontProductController::class)->group(function(){
        Route::group(['as'=> 'product.'], function(){
            ...
            Route::get('/combo-product/{slug}', 'combo_show')->name('combo-product');
    ...
    Route::controller(FrontCartController::class)->group(function(){
        Route::group(['as'=> 'cart.'], function(){
            ...
            Route::post('combo/cart', 'combo_cart')->name('combo_cart');
            ...
            Route::get('comob-cart/{id}', 'combo_cart_destroy')->name('combo_cart_destroy');
            Route::post('/cart/update/{id}', 'update')->name('update');
            Route::get('/printPcBuilder', 'printPcBuilder')->name('printPcBuilder');
            Route::post('apply-coupon', 'applyCoupon')->name('apply-coupon');
            Route::get('/destroy/pc/{id}', 'pcdestroy')->name('pcdestroy');
        });
    });
    ...
    Route::get('/pcbcheckout', [FrontCheckoutController::class,'pcbindex'])->name('pcbindex');
    
    
    Route::post('/store/landing/data', [FrontCheckoutController::class,'storelandData'])->name('storelandData');
    
    Route::post('/store/pc', [FrontCheckoutController::class,'storePc'])->name('storePc');
    ...
    Route::get('front-all-order', [FrontOrderController::class, 'front_all_order'])->name('front_all_order');
    Route::get('front-pending-order', [FrontOrderController::class, 'front_pending_order'])->name('front_pending_order');
    Route::get('front-processing-order', [FrontOrderController::class, 'front_processing_order'])->name('front_processing_order');
    Route::get('front-courier-order', [FrontOrderController::class, 'front_courier_order'])->name('front_courier_order');
    Route::get('front-onhold-order', [FrontOrderController::class, 'front_onhold_order'])->name('front_onhold_order');
    Route::get('front-complete-order', [FrontOrderController::class, 'front_complete_order'])->name('front_complete_order');
    Route::get('front-cancelled-order', [FrontOrderController::class, 'front_cancelled_order'])->name('front_cancelled_order');
    Route::get('front-return-order', [FrontOrderController::class, 'front_return_order'])->name('front_return_order');
    Route::get('track-order', [FrontOrderController::class, 'trackOrder'])->name('trackOrder');
    Route::post('find-track', [FrontOrderController::class, 'findTrack'])->name('findTrack');
    ...
    Route::controller(FrontAuthController::class)->group(function(){
        ...
        Route::post('user-profile-update', 'updateProfile')->name('updateProfile');
        Route::get('user-profile', 'userProfile')->name('userProfile');
        Route::get('user-credentials', 'userCredentials')->name('userCredentials');
        Route::get('print-my-invoice/{id}', 'print_my_invoice')->name('print_my_invoice');
    });
